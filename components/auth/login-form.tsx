  ...
  return (
    <Card className="w-full mx-auto border-border/60 shadow-lg">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Sign in to your TaskFlow account</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-center text-xs text-muted-foreground">
            Forgot your password? <span className="text-primary">Contact support</span>
          </div>
        </form>
